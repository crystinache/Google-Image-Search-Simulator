...
export default function App() {
  ...
  const handleGlobalClick = (e: React.MouseEvent) => {
    ...
    if (nextCount === 1) {
      ...
      if (currentImages.expandedImage2) {
        setExpandedImage(2);
  ...
  const handleExpandedClick = (e: React.MouseEvent) => {
    ...
    if (clickY < threshold) {
      if (expandedImage === 3) {
        ...
        window.location.replace(`https://www.google.com/search?q=${query}&tbm=isch`);
      } else {
        ...
        {!isMenuOpen ? (
          ...
          >
            ...
            <main className="flex-1 flex flex-col" data-screenshot-area="true">
              ...
              {/* Loading Zone / Pause Trigger - No longer used for pause but kept for spacing index if needed */}
